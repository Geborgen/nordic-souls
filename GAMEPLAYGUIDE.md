...
- [Vigilant](https://www.nexusmods.com/skyrimspecialedition/mods/11849) is a questline for the Vigilants of Stendarr. It has a very dark and grim atmosphere, heavily inspired by Dark Souls. It includes a lot of unique armor sets, weapons, jewelry, creatures, and more. To start it, you need to reach level 25, finish [The House of Horrors](https://en.uesp.net/wiki/Skyrim:The_House_of_Horrors), and finish [Kindred Judgement](https://en.uesp.net/wiki/Skyrim:Kindred_Judgment) (Dawnguard DLC finale, side does not matter).
- [Unslaad](https://www.nexusmods.com/skyrimspecialedition/mods/11789) is a quest mod about a half-dragon, and includes fluffy equipment and creatures. Unlike Vigilant, it has a colder and sadder undertone, but also a bit of hope. To start it, you need to reach level 25, finish [Dragonslayer](https://en.uesp.net/wiki/Skyrim:Dragonslayer) (main quest finale), finish Act 4 of Vigilant (ending does not matter, but the "true ending" is recommended), and finish Sacred Anatomancer from Vigilant (the "divine the future" path is recommended, but any path works as long as the quest is completed). Recommended as the finale for your character.
