...
- [The Dragon Cult](https://www.nexusmods.com/skyrimspecialedition/mods/81422) overhauls Draugr. 
...
- [Diplomatic Dragons](https://www.nexusmods.com/skyrimspecialedition/mods/70803) will delay dragon attacks until after Sahloknir is dead.
- [The Dragon Cult - Priesthood](https://www.nexusmods.com/skyrimspecialedition/mods/92794) adds a Dragon Priest skill tree.
- [Wheeler](https://www.nexusmods.com/skyrimspecialedition/mods/97345) is a UI mod that adds a quick action wheel. Press `G`. The mod page has instructions for use, they haven't been modified for the list. If you experience issues with Wheeler (as in crashing or invisible/deleted wheels), open dMenu with `HOME`, find Wheeler's config, and reset all wheels.
...
[Creation Club](https://en.uesp.net/wiki/Skyrim:Creation_Club) content has been fixed, balanced, and integrated into the world through several different mods. Certain quests have been disabled, namely the Alternative Armors quests, in favor of world integration. See the [quest changes](https://github.com/Geborgen/nordic-souls/blob/main/QUESTCHANGES.md) document for more information on CC quest changes.
...
- [Masterwork](https://www.nexusmods.com/skyrimspecialedition/mods/142109) overhauls CC artifacts.

## Quests

In addition new content, Nordic Souls changes the starting requirements for quite a few quests as well. As the list is a bit extensive, I've put the changes in a document [here](https://github.com/Geborgen/nordic-souls/blob/main/QUESTCHANGES.md). If you can't start a quest, it is likely because you haven't met the correct conditions, and you should check that document.
...
- [Beyond Skyrim - Bruma](https://www.nexusmods.com/skyrimspecialedition/mods/10917) is a massive mod that allows you to travel beyond the borders of Skyrim and explore Bruma, the northernmost county in Cyrodiil.
...
- [Olenveld](https://www.nexusmods.com/skyrimspecialedition/mods/133579) is a new lands mod, the size of a small DLC, bringing the lore-rich location of Olenveld to Skyrim. Olenveld is referenced in the book "The Exodus" in Skyrim, telling a tale both eerie and intriguing. This small island, a day’s sail north of Winterhold with good winds, was long forgotten and is said to have been used by Tiber Septim as a burial ground for his conquest's casualties—a haunting landmass filled with the fallen.
- [Vigilant](https://www.nexusmods.com/skyrimspecialedition/mods/11849) is a questline for the Vigilants of Stendarr. It has a very dark and grim atmosphere, heavily inspired by Dark Souls. It includes a lot of unique armor sets, weapons, jewelry, creatures, and more. Check [this document](https://github.com/Geborgen/nordic-souls/blob/main/QUESTCHANGES.md) for the updated starting conditions.
- [Unslaad](https://www.nexusmods.com/skyrimspecialedition/mods/11789) is a quest mod about a half-dragon, and includes fluffy equipment and creatures. Unlike Vigilant, it has a colder and sadder undertone, but also a bit of hope. Check [this document](https://github.com/Geborgen/nordic-souls/blob/main/QUESTCHANGES.md) for the updated starting conditions. Recommended as the finale for your character.
